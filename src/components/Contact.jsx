...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_nhqu4fa', 'template_iv3gh9j', form.current, '0lKwmoQ_0MxGMzSZK')
          .then((result) => {
            ...
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
                ...
                <div className="flex justify-center items-center">
                    <form action="" ref={form} onSubmit={sendEmail}  className="flex flex-col w-full md:w-1/2">
                        ...
                        <input type="text" name="phone" placeholder="Phone no" className="my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"/>
